...
export const FALLBACK_PLANS: Record<string, ProcessedPlan[]> = {
  ...
  'TH': [
    ...
    {
      id: 'th-global-1',
      name: 'Asia and Oceania 30GB 90 days',
      data: '30 GB',
      validity: '90 дни',
      priceUSD: 59.99,
      price: 59.99,
      currency: '$',
      identifier: '21768c30-a2eb-4052-94ab-c02be78a5820',
      priceIdentifier: 'MTpSVEJqbGdYdnU3RUUxVk1BLUFpNElzaVllVEk3RW9xNlNURmkxX1ZJaDlzPTpQcmljZTozMzM0LlVTRC45NTk5',
      planType: 'global',
      coveredCountries: ['AU', 'CN', 'HK', 'ID', 'IN', 'JP', 'KR', 'KZ', 'LK', 'MO', 'MY', 'NZ', 'PH', 'PK', 'SG', 'TH', 'TW', 'UZ', 'VN'],
    },
    {
      id: 'th-global-2',
      name: 'Asia and Oceania 20GB 90 days',
      data: '20 GB',
      validity: '90 дни',
      priceUSD: 45.99,
      price: 45.99,
      currency: '$',
      identifier: 'a3c4e7e8-a9c9-4e35-8c65-25dcad248d3b',
      priceIdentifier: 'MTpSVEJqbGdYdnU3RUUxVk1BLUFpNElzaVllVEk3RW9xNlNURmkxX1ZJaDlzPTpQcmljZTozMzM0LlVTRC45NTk5',
      planType: 'global',
      coveredCountries: ['AU', 'CN', 'HK', 'ID', 'IN', 'JP', 'KR', 'KZ', 'LK', 'MO', 'MY', 'NZ', 'PH', 'PK', 'SG', 'TH', 'TW', 'UZ', 'VN'],
    },
    {
      ...
      price: 35.99,
      currency: '$',
      identifier: '3efb8f49-b246-440b-aebe-108f1a4b7d48',
      priceIdentifier: 'MTpZQV9KTUNhTHAySm16Qll4MUdndktjdHZkQzBlV2tDRjdQY2lHazJSSThjPTpQcmljZTozMzM1LlVTRC4zNTk5',
      planType: 'global',
      coveredCountries: ['AU', 'CN', 'HK', 'ID', 'IN', 'JP', 'KR', 'KZ', 'LK', 'MO', 'MY', 'NZ', 'PH', 'PK', 'SG', 'TH', 'TW', 'UZ', 'VN'],
    },
    {
      id: 'th-global-4',
      name: 'Asia and Oceania 5GB 30 days',
      data: '5 GB',
      validity: '30 дни',
      priceUSD: 19.49,
      price: 19.49,
      currency: '$',
      identifier: '46082f9c-e69a-4ddf-a9e0-b757e1fe9f1b',
      priceIdentifier: 'MTpQUVA4NUhPTThDck5keGJtVFBFd2ViNEtDZmtlV3VQd3NHeEdycmZOeVYwPTpQcmljZToyOTM2LlVTRC4xOTQ5',
      planType: 'global',
      coveredCountries: ['AU', 'CN', 'HK', 'ID', 'IN', 'JP', 'KR', 'KZ', 'LK', 'MO', 'MY', 'NZ', 'PH', 'PK', 'SG', 'TH', 'TW', 'UZ', 'VN'],
    },
    {
      id: 'th-global-5',
      name: 'Asia and Oceania 3GB 30 days',
      data: '3 GB',
      validity: '30 дни',
      priceUSD: 12.49,
      price: 12.49,
      currency: '$',
      identifier: '09d993ab-b35a-4c4a-808f-f2b3667fcec0',
      priceIdentifier: 'MTpMTU5xdnNOMFBQdkFKUGNSdEp1dF9HOUZYUkFVQ2dZX1Q2RXhLMDZhU1A0PTpQcmljZToyOTM3LlVTRC4xMjQ5',
      planType: 'global',
      coveredCountries: ['AU', 'CN', 'HK', 'ID', 'IN', 'JP', 'KR', 'KZ', 'LK', 'MO', 'MY', 'NZ', 'PH', 'PK', 'SG', 'TH', 'TW', 'UZ', 'VN'],
    },
    {
      id: 'th-global-6',
      name: 'Asia and Oceania 1GB 7 days',
      data: '1 GB',
      validity: '7 дни',
      priceUSD: 4.99,
      price: 4.99,
      currency: '$',
      identifier: 'e0b99f00-dc6b-4ae5-b58f-526204d8f434',
      priceIdentifier: 'MToyVWZqZ0dpNVd0aXpibGJrdVBYU3BqOXF0R050UmsySm84MjZ4T2ZDUC0wPTpQcmljZToyOTM4LlVTRC40OTk=',
      planType: 'global',
      coveredCountries: ['AU', 'CN', 'HK', 'ID', 'IN', 'JP', 'KR', 'KZ', 'LK', 'MO', 'MY', 'NZ', 'PH', 'PK', 'SG', 'TH', 'TW', 'UZ', 'VN'],
    },
    {
  ...
  'EG': [
    ...
    {
      id: 'eg-global-1',
      name: 'Africa 1GB 7 days',
      data: '1 GB',
      validity: '7 дни',
      priceUSD: 26.49,
      price: 26.49,
      currency: '$',
      identifier: '9d2f5760-95fb-4f08-a7e3-6d1b6b82337c',
      priceIdentifier: 'MTpRZU1saHBuS2NmN3J6Q1M5aDNPMGJULU5Mb2pfNlRvaDAzbDI0ck5FcUVVPTpQcmljZToyOTIyLlVTRC4yNjQ5',
      planType: 'global',
      coveredCountries: ['BF', 'BJ', 'BW', 'CM', 'CV', 'DZ', 'EG', 'GA', 'GH', 'GN', 'GW', 'KE', 'LR', 'MG', 'ML', 'MU', 'MW', 'NG', 'RW', 'SC', 'SD', 'SN', 'SZ', 'TD', 'TG', 'UG', 'ZA', 'ZM'],
    },
    {
      id: 'eg-global-2',
      name: 'Middle East and North Africa 3GB 30 days',
  ...
  'US': [
    ...
    // Regional Plans - Real data from Saily API
    {
      ...
      price: 43.99,
      currency: '$',
      identifier: '797dfb87-7fc1-4378-a154-b23b482c2ca1',
      priceIdentifier: 'MTpyY3JyUUFrWXFNdC1tOE9xQURfX3RNdktzeERrdzF6RGx4WGZ1Z05GZ01JPTpQcmljZTozMzQ4LlVTRC40Mzk5',
      planType: 'regional',
      coveredCountries: ['US', 'CA', 'MX'],
    },
    {
      id: 'us-regional-2',
      name: 'North America 5GB 30 days',
      data: '5 GB',
      validity: '30 дни',
      priceUSD: 23.99,
      price: 23.99,
      currency: '$',
      identifier: '85236a86-5477-410b-8f44-db8e06ae2e19',
      priceIdentifier: 'MTpaaVRoWnFYQllkNkRFX1lvZWUzakx4MHdGaW9LVlpGWm5KSlJYa3RBbk5ZPTpQcmljZTozMzQ5LlVTRC4yMzk5',
      planType: 'regional',
      coveredCountries: ['US', 'CA', 'MX'],
    },
    {
      id: 'us-regional-3',
      name: 'North America 3GB 30 days',
      data: '3 GB',
      validity: '30 дни',
      priceUSD: 15.99,
      price: 15.99,
      currency: '$',
      identifier: 'dee4d01b-0d9e-4193-a1ec-f3981d2859cd',
      priceIdentifier: 'MTppZ0ZtU0JmX3ZCbHYxMnQtZkpJZ05MUUJMNnZYclRQSkJuN2pGT3gtTVY0PTpQcmljZTozMzUwLlVTRC4xNTk5',
      planType: 'regional',
      coveredCountries: ['US', 'CA', 'MX'],
    },
    {
      id: 'us-regional-4',
      name: 'North America 2GB 15 days',
      data: '2 GB',
      validity: '15 дни',
      priceUSD: 11.49,
      price: 11.49,
      currency: '$',
      identifier: '4968306a-bdee-41d3-889b-3570e2b6a362',
      priceIdentifier: 'MTpYZHFSVWxZU2todjRBemp6cUQ3UVJhT0V4QkFJSVZYdTdDNVA1QW5ZaVRzPTpQcmljZTozMzUxLlVTRC4xMTQ5',
      planType: 'regional',
      coveredCountries: ['US', 'CA', 'MX'],
    },
    {
      id: 'us-regional-5',
      name: 'North America 1GB 7 days',
      data: '1 GB',
      validity: '7 дни',
      priceUSD: 5.99,
      price: 5.99,
      currency: '$',
      identifier: '10eba6ab-adfb-45aa-acd0-adabd936bee0',
      priceIdentifier: 'MTpZTnNraUdWVk0tYUUtUVBWVUlkTEVZcUdMcGNpN1BCd0ZzYUh0ZDVRakpNPTpQcmljZTozMzUyLlVTRC41OTk=',
      planType: 'regional',
      coveredCountries: ['US', 'CA', 'MX'],
    },
    // Global Plans - Real data from Saily API
  ...
  'GB': [
    ...
    {
      id: 'gb-global-1',
      name: 'Europe 50GB 90 days',
      data: '50 GB',
      validity: '90 дни',
      priceUSD: 95.99,
      price: 95.99,
      currency: '$',
      identifier: '5dbfd151-1183-4959-be09-6e28a43f489b',
      priceIdentifier: 'MTpCcGo0ZnBpamIzNG1qbE80N3BBSVRnZ3F1MU85cUV2STlNeXlSRXVRbUl3PTpQcmljZTozMzI4LlVTRC45NTk5',
      planType: 'global',
      coveredCountries: ['AT', 'BE', 'BG', 'CH', 'CY', 'CZ', 'DE', 'DK', 'EE', 'ES', 'FI', 'FR', 'GB', 'GI', 'GR', 'HR', 'HU', 'IE', 'IS', 'IT', 'LI', 'LT', 'LU', 'LV', 'MC', 'MT', 'NL', 'NO', 'PL', 'PT', 'RO', 'SE', 'SI', 'SK', 'TR'],
    },
    {
      id: 'gb-global-2',
      ...
      price: 35.99,
      currency: '$',
      identifier: '866817d7-0289-4d74-aeab-21b730c7a88e',
      priceIdentifier: 'MTpqdjZmdkNLclp2bkZDUWRTc2QwblhvQXBVclFvcTZ0bUYtY0llUUJYT1VVPTpQcmljZTozMzI5LlVTRC4zNTk5',
      planType: 'global',
      coveredCountries: ['AT', 'BE', 'BG', 'CH', 'CY', 'CZ', 'DE', 'DK', 'EE', 'ES', 'FI', 'FR', 'GB', 'GI', 'GR', 'HR', 'HU', 'IE', 'IS', 'IT', 'LI', 'LT', 'LU', 'LV', 'MC', 'MT', 'NL', 'NO', 'PL', 'PT', 'RO', 'SE', 'SI', 'SK', 'TR'],
    },
    {
      ...
      price: 19.49,
      currency: '$',
      identifier: '4073686d-4e13-45f6-b665-d9500f551f6b',
      priceIdentifier: 'MTpIUV9oZkU3U0ZoNW9ZbkYwbk5tZUdFbTlYbHU1ejZ2SS1aTGM2dWJtcUFzPTpQcmljZTozMzMwLlVTRC4xOTQ5',
      planType: 'global',
      coveredCountries: ['AT', 'BE', 'BG', 'CH', 'CY', 'CZ', 'DE', 'DK', 'EE', 'ES', 'FI', 'FR', 'GB', 'GI', 'GR', 'HR', 'HU', 'IE', 'IS', 'IT', 'LI', 'LT', 'LU', 'LV', 'MC', 'MT', 'NL', 'NO', 'PL', 'PT', 'RO', 'SE', 'SI', 'SK', 'TR'],
    },
    {
      id: 'gb-global-4',
      name: 'Europe 3GB 30 days',
      data: '3 GB',
      validity: '30 дни',
      priceUSD: 12.49,
      price: 12.49,
      currency: '$',
      identifier: '2825b561-63fd-4f52-a691-7edf346162d4',
      priceIdentifier: 'MTowR3Q2S3BoRDByYm10dURyVmRHUzhsZmc5S1c0V1NoNnVvNjdLaTcwcWhNPTpQcmljZTozMzMxLlVTRC4xMjQ5',
      planType: 'global',
      coveredCountries: ['AT', 'BE', 'BG', 'CH', 'CY', 'CZ', 'DE', 'DK', 'EE', 'ES', 'FI', 'FR', 'GB', 'GI', 'GR', 'HR', 'HU', 'IE', 'IS', 'IT', 'LI', 'LT', 'LU', 'LV', 'MC', 'MT', 'NL', 'NO', 'PL', 'PT', 'RO', 'SE', 'SI', 'SK', 'TR'],
    },
    {
      ...
      price: 4.99,
      currency: '$',
      identifier: '894049c4-9c65-4d36-a055-72e099818b78',
      priceIdentifier: 'MTp3Z0hWYy1hWGtHSjVxRGp4U0hsMTU1ak1TdDBfclF1M01tMkN3SVlTbEdrPTpQcmljZTozMzMyLlVTRC40OTk=',
      planType: 'global',
      coveredCountries: ['AT', 'BE', 'BG', 'CH', 'CY', 'CZ', 'DE', 'DK', 'EE', 'ES', 'FI', 'FR', 'GB', 'GI', 'GR', 'HR', 'HU', 'IE', 'IS', 'IT', 'LI', 'LT', 'LU', 'LV', 'MC', 'MT', 'NL', 'NO', 'PL', 'PT', 'RO', 'SE', 'SI', 'SK', 'TR'],
    },
    {
  ...
  'ID': [
    ...
    {
      id: 'id-1',
      name: 'Indonesia 1GB 7 days',
      data: '1 GB',
      validity: '7 дни',
      priceUSD: 4.79,
      price: 4.79,
      currency: '$',
      identifier: 'k7xJjVbnyAHkMuA7k_rN2tvr58zpaF0VAf5bYYrLf2k',
      priceIdentifier: 'MTprNHhCampWbnlBSGtNdUE3a19yTjJ0dnI1OHpwYUYwVkFmNWJZWXJMZjJrPTpQcmljZToyNzM1LlVTRC40Nzk=',
      planType: 'country',
      coveredCountries: ['ID'],
    },
    {
      id: 'id-2',
      name: 'Indonesia 3GB 30 days',
      data: '3 GB',
      validity: '30 дни',
      priceUSD: 6.99,
      price: 6.99,
      currency: '$',
      identifier: 'indonesia-3gb-30d',
      planType: 'country',
      coveredCountries: ['ID'],
    },
    {
      id: 'id-3',
      name: 'Indonesia 5GB 30 days',
      data: '5 GB',
      validity: '30 дни',
      priceUSD: 8.99,
      price: 8.99,
      currency: '$',
      identifier: 'indonesia-5gb-30d',
      planType: 'country',
      coveredCountries: ['ID'],
    },
    {
      id: 'id-4',
      name: 'Indonesia 10GB 30 days',
      data: '10 GB',
      validity: '30 дни',
      priceUSD: 12.99,
      price: 12.99,
      currency: '$',
      identifier: 'indonesia-10gb-30d',
      planType: 'country',
      coveredCountries: ['ID'],
    },
    {
      id: 'id-5',
      name: 'Indonesia 20GB 30 days',
      data: '20 GB',
      validity: '30 дни',
      priceUSD: 21.99,
      price: 21.99,
      currency: '$',
      identifier: 'indonesia-20gb-30d',
      planType: 'country',
      coveredCountries: ['ID'],
    },
    // Regional Plans - Asia and Oceania (includes Indonesia)
    {
      id: 'id-regional-1',
      name: 'Asia and Oceania 30GB 90 days',
      data: '30 GB',
    ...
    // Global Plans (includes Indonesia)
    {
      id: 'id-global-1',
      name: 'Global 20GB 365 days',
      data: '20 GB',
