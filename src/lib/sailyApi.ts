...
export const FALLBACK_PLANS: Record<string, ProcessedPlan[]> = {
  ...
  'TR': [
    ...
    // Regional Plans (Europe/Middle East)
    {
      id: 'tr-regional-1',
      name: 'Europe & Middle East 2GB 7 days',
      data: '2 GB',
      validity: '7 дни',
      priceUSD: 7.99,
      price: 7.99,
      currency: '$',
      identifier: 'saily_europe_me_2gb_7d',
      planType: 'regional',
      coveredCountries: ['TR', 'GR', 'BG', 'RO', 'DE', 'FR', 'IT', 'ES', 'AE', 'SA'],
    },
    {
      id: 'tr-regional-2',
      name: 'Europe & Middle East 5GB 15 days',
      data: '5 GB',
      validity: '15 дни',
      priceUSD: 12.99,
      price: 12.99,
      currency: '$',
      identifier: 'saily_europe_me_5gb_15d',
      planType: 'regional',
      coveredCountries: ['TR', 'GR', 'BG', 'RO', 'DE', 'FR', 'IT', 'ES', 'AE', 'SA'],
    },
    {
      id: 'tr-regional-3',
      name: 'Europe & Middle East 10GB 30 days',
      data: '10 GB',
      validity: '30 дни',
      priceUSD: 18.99,
      price: 18.99,
      currency: '$',
      identifier: 'saily_europe_me_10gb_30d',
      planType: 'regional',
      coveredCountries: ['TR', 'GR', 'BG', 'RO', 'DE', 'FR', 'IT', 'ES', 'AE', 'SA'],
    },
    // Global Plans
    {
      ...
      planType: 'global',
      coveredCountries: ['TR', 'US', 'GB', 'DE', 'FR', 'IT', 'ES', 'NL', 'BE', 'CH', 'AT', 'IE', 'PT', 'GR', 'SE', 'NO', 'DK', 'FI', 'PL', 'CZ', 'HU', 'RO', 'BG', 'HR', 'SK', 'SI', 'LT', 'LV', 'EE', 'TH', 'SG', 'MY', 'AU', 'NZ', 'AE', 'SA'],
    },
    {
      id: 'tr-global-2',
